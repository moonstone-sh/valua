...
describe("Modularity & Architecture Invariants", function()
    ...
    it("manifest matches all expected public symbols", function()
        ...
        assert_true(manifest.methods.contracts == "valua.contracts")
    end)
    ...
    it("root init exposes all symbols from manifest", function()
        ...
        assert_true(type(v.contracts) == "function")
        assert_true(type(v.export) == "function")
        assert_true(type(v.contract_typescript.render) == "function")
        assert_true(type(v.contract_json_schema.render) == "function")
    end)
end)
